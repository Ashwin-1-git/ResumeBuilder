...
function Userinputs() {
  ...
  // create state for storeing resume details
...
const skillref= React.useRef()
  ...
  if (resumeDetails.userSkills.includes(skill)) {
    ...
    setResumeDetails({
      ...resumeDetails,
      userSkills: [...resumeDetails.userSkills, skill],
    });
    // to clear the add skill text box
      ...
      case 0: return (
        <div>
          ...
          <div className='row p-3' >
            ...
            <TextField value={resumeDetails.jobtitle} onChange={e=>setResumeDetails({...resumeDetails,jobtitle:e.target.value})} id="standard-basic-job" label="Job titles" variant="standard" />
      ...
      case 2: return (
        <div>
          ...
          <div className='row p-3' >
            ...
            <TextField value={resumeDetails.collage} onChange={e=>setResumeDetails({...resumeDetails,collage:e.target.value})}  id="standard-basic-college" label="College Name" variant="standard" />
